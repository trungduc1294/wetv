...
class ExploreController extends GetxController {
  ...
  List<List<String>> get filterGroupOptions => [
    ...
    [TrKeys.fullSeries.tr, '2026', '2025', '2024', '2023', '2022'],
  ];
  ...
  Future<void> getRankingMovies() async {
    try {
      final result = await _movieListApi.getRankingMovies();
      rankingMovies.assignAll(result);
    } catch (e) {
      print(e);
    }
  }
